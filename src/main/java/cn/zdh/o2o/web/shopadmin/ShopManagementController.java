...
import cn.zdh.o2o.service.AreaService;
import cn.zdh.o2o.service.ShopCategoryService;
import cn.zdh.o2o.service.ShopService;
import cn.zdh.o2o.util.CodeUtil;
import cn.zdh.o2o.util.HttpServletRequestUtil;
import cn.zdh.o2o.util.ImageUtil;
import cn.zdh.o2o.util.PathUtil;
    ...
    private Map<String, Object> getShopById(HttpServletRequest request){
        ...
        if(shopId > -1){
            try {
                ...
                modelMap.put("eerMsg", e.toString());
            }
        }else {
            modelMap.put("success", false);
            modelMap.put("eerMsg", "empty shopId");
        }
        return modelMap;
    }
